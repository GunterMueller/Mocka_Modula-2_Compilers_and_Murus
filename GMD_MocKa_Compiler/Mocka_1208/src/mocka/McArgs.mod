...
(*  Christian Maurer, 5.8.12   >>>>>>>>>>>>>>>>>>>>>>>>>> *)
    Assign (BindScript,      "/usr/local/m2/bin/link");
    Assign (EditScript,      "/usr/local/m2/bin/edit");
    Assign (ListerScript,    "/usr/local/m2/bin/list");
    Assign (AssemblerScript, "/usr/local/m2/bin/asm");
    Assign (DefaultLib,      "/usr/local/m2/out/mockalib");
(*  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< *)
